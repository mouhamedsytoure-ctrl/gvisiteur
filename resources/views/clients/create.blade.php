...
@section('title', 'Nouveau client – Gestion des visites')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h3 class="mb-1">Nouveau client</h3>
            <p class="text-muted mb-0">Enregistrer un nouveau client dans le système.</p>
        </div>
        <div>
